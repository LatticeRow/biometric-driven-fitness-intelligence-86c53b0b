...
struct Palette {
    static let backgroundTop = NSColor(srgbRed: 0.02, green: 0.03, blue: 0.05, alpha: 1.0)
    static let backgroundBottom = NSColor(srgbRed: 0.06, green: 0.10, blue: 0.14, alpha: 1.0)
    static let gold = NSColor(srgbRed: 0.83, green: 0.69, blue: 0.42, alpha: 1.0)
